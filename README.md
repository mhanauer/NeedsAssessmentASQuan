---
title: "Needs Asssessment CCR Quantiative"
...
rbbcsc = rbbcsc[-c(1:2),]
head(rbbcsc)
rbbcsc1 = rbbcsc[c("Q7_1", "Q7_2", "Q7_3", "Q7_4", "Q7_5", "Q7_6")]
eth = rbbcsc[c("Q11")]
gender = rbbcsc[c("Q10")]
edu = rbbcsc[c("Q12")]
job = rbbcsc[c("Q15")]
...
head(rbbcsc, 20)
head(rbbcsc)
colnames(rbbcsc) = c("ASQuant1", "ASQuant2", "ASQuant3", "ASQuant4", "ASQuant5", "ASQuant6", "eth", "gender", "edu", "job") 
...
mccsc1 = mccsc[c("Q9_1", "Q9_2", "Q9_3", "Q9_4", "Q9_5", "Q9_6")]
eth = mccsc[c("Q30")]
gender = mccsc[c("Q36")]
edu = mccsc[c("Q38")]
job = mccsc[c("Q44")]
...
head(mccsc)
colnames(mccsc) = c("ASQuant1", "ASQuant2", "ASQuant3", "ASQuant4", "ASQuant5", "ASQuant6", "eth", "gender", "edu", "job") 
head(mccsc)
...
dim(mccsc)
dim(rbbcsc)
bothGender = bothAll[c("ASQuant1", "ASQuant2", "ASQuant3", "ASQuant4", "ASQuant5", "ASQuant6", "gender")]
head(bothGender)
...
bothGender = bothAll[c("ASQuant1", "ASQuant2", "ASQuant3", "ASQuant4", "ASQuant5", "ASQuant6", "eth")]
head(bothGender)
bothGender = na.omit(bothGender)
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
bothGender = na.omit(bothGender)
...
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
# Change this
bothGender = bothAll[c("ASQuant1", "ASQuant2", "ASQuant3", "ASQuant4", "ASQuant5", "ASQuant6", "edu")]
head(bothGender)
bothGender = na.omit(bothGender)
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
bothGender = na.omit(bothGender)
...
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
# Change this
bothGender = bothAll[c("ASQuant1", "ASQuant2", "ASQuant3", "ASQuant4", "ASQuant5", "ASQuant6", "job")]
head(bothGender)
bothGender = na.omit(bothGender)
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
bothGender = na.omit(bothGender)
